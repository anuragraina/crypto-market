				...
				<div className='grid grid-cols-1 sm:grid-cols-2  '>
					<div className='font-bold text-[20px] text-center mx-auto sm:text-left xl:text-[29px] w-[80%] text-white p-4'>
						...
						<p className=' text-[#c0c0c0]  pt-5 hidden sm:inline-flex font-normal text-[15px] mx-auto  sm:text-[15px] md:text-[15px] lg:text-[15px] xl:text-[15px]'>
							buying and selling cryptocurrencies on a cryptocurrency exchange or trading platform in
							order to make a profit from the price fluctuations of cryptocurrencies.
						</p>
						<p className=' text-[#d2d1d1]  pt-5 hidden sm:inline-flex font-normal text-[15px] mx-auto  sm:text-[15px] md:text-[15px] lg:text-[15px] xl:text-[15px]'>
							It's important to keep in mind that crypto trading requires discipline and a long-term
							strategy, as well as the ability to manage risk effectively. It's also recommended to start
							with a small investment and gradually increase your exposure as you gain experience and
							knowledge.
						</p>
					</div>
