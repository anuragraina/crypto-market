...
export default function CoinSell() {
	...
	useEffect(() => {
		setAmount(
			((`${state.data.current_price}` / 100) * 70 * Quantity).toLocaleString('en-IN', {
				maximumFractionDigits: 2,
				style: 'currency',
				currency: 'INR',
			})
	...
	useEffect(() => {
		setQuantity_for_amount(Amount_for_amount / ((`${state.data.current_price}` / 100) * 70));
	}, [Amount_for_amount]);
	...
	return (
		<div className='m-5 '>
			...
			<div className=' z-30 w-[80%] mx-auto p-5 bg-[#1d2230] rounded-md'>
				<div className='font-bold text-white text-center text-[20px] md:text-[22px] mb-12'>Confirm Payment</div>
				<div className=' m-5 grid grid-cols-1 md:grid-cols-2  '>
					...
					<div className=' grid grid-cols-1 md:grid-cols-2 md:space-x-3 '>
						<div className='p-3 mb-4 mx-auto bg-[#171b26] rounded-lg text-white pt-6'>
							<div className='text-center font-medium mb-5 text-[17px]'>Buy by Qantity</div>
               ...
               p-1 mt-6  rounded-md font-semibold text-[12px] md:text-[15px] mb-4'
						...
						<div className='p-3 mb-4 mx-auto bg-[#171b26] rounded-lg text-white pt-6'>
							...
							<div className='grid grid-cols-1 m-3 md:mt-5'>
								...
								<div className='text-[13px] md:text-[17px]'>{Quantity_for_amount}</div>
							</div>
							<button
